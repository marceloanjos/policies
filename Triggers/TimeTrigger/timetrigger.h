...
/**
 * @brief Triggers a policy based on a specific time
 */
class TimeTrigger : public QObject, public iTrigger
{
    Q_OBJECT
    Q_INTERFACES(iTrigger)
    Q_PLUGIN_METADATA(IID "PluginService.Trigger.TimeTrigger")
