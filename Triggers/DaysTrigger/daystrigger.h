#ifndef DAYSTRIGGER_H
#define DAYSTRIGGER_H
...
/**
 * @brief Triggers if the current date is X number of days from the last update
 */
class DaysTrigger : public QObject, public iTrigger
{
    Q_OBJECT
...
public:
    explicit DaysTrigger(QObject *parent = 0);
